...
| Slayer unlock thresholds (Pass 10) | **Confirmed**: Wolf **T4** → Enderman, Enderman **T3** → Blaze. Previous code had T1/T2 which was wrong. Zombie T2→Spider and Spider T2→Wolf remain correct. |
| Vampire Slayer unlock chain (Pass 10) | **Confirmed NOT tied to Blaze T3**. Vampire is unlocked via Rift progression: enter Rift → progress questline through Dreadfarm/Village Plaza → reach Stillgore Château → find Maddox. Requires Rift-specific gear (Coven Leggings + Steak Stake/Silver Karambit). Holy Ice needed T2+. |
| Farming armor path (Pass 10) | **Confirmed correct path**: Melon → Cropie → Squash → Fermento → Helianthus. Previous engine had Lotus/Pesthunter which are NOT farming armor pieces in this path. |
| Pest farming income (Pass 10) | **Confirmed**: 30–40M/hr mid setup (Fermento + Pest Chance ~100). Up to 70M/hr maxed (Helianthus + Green Thumb 5 + Pest Chance 300+). During Finnegan: rates roughly double. Previous estimate of 40–50M/hr was too conservative for the high end, too generous for the entry. |
| Gemstone mining income (Pass 10) | **Confirmed tiered**: HOTM 7 mid (Gauntlet/Sorrow): 10–20M/hr. Late (Divan+x655 drill): 30–45M/hr. Hypermaxed: 60–110M+/hr. Pristine stat is #1 profit driver; server ping >200ms halves rates. Peridot (Glacite) best raw coins; Jade (Mines of Divan) most consistent. |
| Kuudra income per tier (Pass 10) | **Confirmed**: T1-T2: 5–15M/hr. T3: 20–30M/hr. T4: 35–50M/hr. T5: 60–120M+/hr. Previous claim of "30–50M/hr entry" was significantly inflated. |
| Dungeon class meta nuance (Pass 10) | **Confirmed phase-based**: F1-F3: Berserker/Mage (Dreadlord Sword). F4-F6: Archer (Juju Shortbow) or Berserker. F7: Mage (Hyperion) or Archer (Terminator). MM: Tank (near-essential) + Archer (DPS). Switch Berserker→Archer when you can afford Juju + 400-600 MP. |
| HOTM node priority (Pass 10) | **Confirmed**: Star Powder and Cheapskate are "traps" in 2026 — marginal benefit vs active mining. Great Explorer is #1 at HOTM 7. Surveyor is #1 at HOTM 8+ for Glacite Mine Shafts. Pristine (HOTM 10 perk) is the #1 gemstone income stat. |
